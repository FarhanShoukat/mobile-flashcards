...
class DeckDetail extends Component {
    ...
    addCard = () => this.props.navigation.navigate('Add Card', {deckTitle: this.props.deck.title})
    ...
    startQuiz = () => {
        ...
        if (deck.questions.length)
            ...
            Alert.alert('No cards in deck', 'You cannot take the quiz. Deck has no cards.')
    }
